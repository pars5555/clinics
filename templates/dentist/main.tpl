...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        {include file="$TEMPLATE_DIR/dentist/util/headerControls.tpl"}
    </head>
    <body>
        <div class="wrapper">
            ...
            {include file="$TEMPLATE_DIR/dentist/util/header.tpl"} 
            <div class="dentist-panel-right-wrapper">
                {nest ns=content}
            </div>
            {include file="$TEMPLATE_DIR/dentist/util/footer.tpl"} 
