<!-- NGS Theme Styles -->
<link rel="stylesheet" type="text/css" href="{$SITE_PATH}/css/clinic/style.css?{$VERSION}" />
<link rel="stylesheet" type="text/css" href="{$SITE_PATH}/css/clinic/skin.css?{$VERSION}" />
