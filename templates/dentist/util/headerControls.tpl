<!-- NGS Theme Styles -->
<link rel="stylesheet" type="text/css" href="{$SITE_PATH}/css/dentist/style.css?{$VERSION}" />
<link rel="stylesheet" type="text/css" href="{$SITE_PATH}/css/dentist/skin.css?{$VERSION}" />
